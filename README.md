[![Run App Koen Dietrich](https://github.com/kdietrich8/GithubActions/actions/workflows/run-app.yaml/badge.svg)](https://github.com/kdietrich8/GithubActions/actions/workflows/run-app.yaml)
